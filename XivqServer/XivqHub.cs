...
using XIVq.Common.Protocol;
using XIVq.Common.Protocol.Clientbound;
using XIVq.Common.Protocol.Serverbound;

namespace XIVq.Server;

public class XivqHub : Hub
{
    private readonly ILogger<XivqHub> _logger;
    private readonly ClientManager _manager;

    public XivqHub(ILogger<XivqHub> logger, ClientManager manager)
    {
        _logger = logger;
        _manager = manager;
    }
