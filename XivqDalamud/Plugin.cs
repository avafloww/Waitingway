...
using XIVq.Dalamud.Network;

namespace XIVq.Dalamud;

public class Plugin : IDalamudPlugin
{
    public string Name => "XIVq";
    ...
    public Plugin()
    {
        ...
        PluginLog.Log($"XIVq Client ID: {_config.ClientId}");

        _client = new XivqClient("http://localhost:5053", _config.ClientId);
